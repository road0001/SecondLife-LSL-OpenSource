...
# 粒子终点发光效果
particleGlowEnd=0.2
# 各模式下粒子贴图（用于菜单中的Style选项，请勿配置超过3个以节省内存）
particleTextureList=Ribbon;cdb7025a-9283-17d9-8d20-cee010f36e90;Chain;4cde01ac-4279-2742-71e1-47ff81cc3529;None;8dcd4a48-2d37-4909-9f78-f7a9eb4ef903
# 粒子颜色列表（用于菜单中的Style选项，请勿配置超过20个以节省内存）
