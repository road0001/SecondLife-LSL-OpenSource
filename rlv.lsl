initConfig(){
    rlvCmdList=[
        ...
        // Page 1
        //[ALL]
		"LightBlind","+blind,_light,camdistmax:15,camdistmax:5?y?y,setsphere,setsphere_tween:1?force,setsphere_distmin:10?force,setsphere_distmax:15?force,setsphere_valuemin:0?force,setcam_unlock?y?y","Vision",0,
		"HeavyBlind","+blind,_heavy,camdistmax:15?y?y,camdistmax:5,setsphere,setsphere_tween:1?force,setsphere_distmin:2.5?force,setsphere_distmax:5?force,setsphere_valuemin:0?force,setcam_unlock","Vision",0,
        
        "Echo","_light,_heavy,rext_echoview","Vision",0,
		"CameraFar","_camera,camdistmax:15","Vision",0,
		"CameraNear","_camera,camdistmax:5","Vision",0,

		"CameraLock","setcam_unlock","Vision",0,
		...
		"Turn","_turn,rext_turn","Move",0,
		"MoveTurn","_move,_turn,rext_move,rext_turn","Move",0,
